...
{type: "item",name: "Men's Haircut",price: "$27+",},
{type: "item",name: "Kid's Haircut",price: "$27+",description: "Ages 10 and Under",},
{type: "item",name: "Undercut",price: "$17",},
{type: "item",name: "Bang Trim",price: "$17",},
{type: "item",name: "Beard Trim",price: "$17",},
...
{type: "group",name: "Colours & Toner",description: "Please note that all colour services require varying amounts of product depending on hair type and length. If additional product is required, a charge of $12.50 per bowl will be added.",},
{type: "subgroup",name: "Colours",},
{type: "item",name: "Express Root Retouch",price: "$80+",description: "The express root retouch features a quick 9 minute processing time! As only common colours are avaliable, first time clients are recommended to book a regular root retouch and then inquire during the appointment if an express retouch can be used for your hair.",},
{type: "item",name: "Full Colour",price: "$130+",},
{type: "item",name: "Root Retouch",price: "$80+",},
{type: "item",name: "Colour Correction",price: "$260+",},
{type: "subgroup",name: "Toner",},
{type: "item",name: "Toner for Short Hair",price: "$55+",},
{type: "item",name: "Toner for Long Hair",price: "$80+",description: "Shoulder Length Hair and Longer",},
{type: "group",name: "Highlights",description: "Please note that all colour services require varying amounts of product depending on hair type and length. If additional product is required, a charge of $12.50 per bowl will be added.",},
{type: "subgroup",name: "Partial Highlights",},
{type: "item",name: "Partial Highlights for Short Hair",price: "$100+",},
{type: "item",name: "Partial Highlights for Long Hair",price: "$125+",},
{type: "subgroup",name: "Three-Quarter Highlights",},
{type: "item",name: "Three-Quarter Highlights for Short Hair",price: "$125+",},
{type: "item",name: "Three-Quarter Highlights for Long Hair",price: "$150+",},
{type: "subgroup",name: "Full Highlights",},
{type: "item",name: "Full Highlights for Short Hair",price: "$150+",},
{type: "item",name: "Full Highlights for Long Hair",price: "$175+",},
...
{type: "group",name: "Fusion Hair Extensions",},
...
bio: "Kat is a licensed stylist who has been in the hair industry for over 17 years. Being a St.Thomas local born and raised, Kat has had the best experience getting to know the town she grew up in through each client that has sat in her chair. She specializes in highlighting, cut, colouring and balayage.\nKat is dedicated to getting to know her clients and customizing their colour to fully suit their lifestyle. Low maintenance and natural tones to are Kat's favourite to help her clients feel their best while also having beautiful longevity.",
primaryButtonText: "Book on Instagram",
primaryButtonLink: "https://www.instagram.com/kat.feairs.hair/",
externalServicesLink: "https://www.instagram.com/kat.feairs.hair/",
isAcceptingNewClients: false,
},
{
name: "Jenna Shortt",
position: "Hairstylist",
bio: "With over 10.5 years behind the chair, Jenna truly found her passion in creating beautiful, dimensional lived-in hair - especially balayage, foilage, and highlights. There's nothing she loves more than seeing her clients light up and leave feeling like the best, most confident version of themselves. Jenna strongly believes that healthy hair is everything, and that what you do at home is just as important-if not more-than what we do in the salon.\nJenna specializes in lived-in blondes and brunettes that grow out seamlessly and fit effortlessly into your everyday lifestyle. She is always staying up to date with the latest trends to bring fresh, modern looks to her clients. At the moment, Jenna is not accepting new clients, but feel free to send her a message through Instagram direct message to be added to her waitlist in case of cancellations. She posts last-minute openings to her Instagram stories - first come, first serve. Jenna can't wait to have you in her chair at Luxe!",
primaryButtonText: "Book on Instagram",
primaryButtonLink: "https://www.instagram.com/hairbyjennashortt/",
externalServicesLink: "https://www.instagram.com/hairbyjennashortt/",
isAcceptingNewClients: false,
},
{
name: "Faith Vannoord",
