...
function Footer({
  ...
  return (
    <div className={className}>
      <div
        className="container-fluid mx-0 py-5 text-light"
      ...
      >
        <div className="row px-4">
          <div className="col-md-4 py-2 py-md-0">
            ...
            <li className="list-group-item border-0 p-0" key={"notes"}>
              <div className="row">
                <i className="col d-inline m-0 pt-2">{hoursOfOp.notes}</i>
              </div>
            </li>
          </div>
          <div className="col-md-4 py-2 py-md-0">
            ...
            <ul className="list-group">
              ...
              <li
                className="list-group-item border-0 text-bg-dark p-0 pt-3 mx-5"
                key={"social"}
              >
                <div className="d-flex justify-content-center justify-content-md-start ps-md-5">
                  ...
                  <a className="m-1 px-1" href={Links.facebook} target="_blank">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="32"
                      height="32"
